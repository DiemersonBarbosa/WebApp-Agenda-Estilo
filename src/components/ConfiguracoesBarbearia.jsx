...
import { Store, Save, Check, ExternalLink, Share2, Copy, MessageCircle, Send, X, MessageSquare, Bot, Grid, Palette } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-28 px-4 sm:px-6 text-slate-100 font-sans">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* BLOCO ÚNICO CONTÍNUO (CAPA + FORMULÁRIO UNIFICADOS) */}
        <div className="rounded-3xl bg-slate-900 border border-slate-800 shadow-xl overflow-hidden">
          
          {/* TOPO: CAPA E PERFIL INTEGRADOS */}
          ...
          {/* CONTEÚDO DO FORMULÁRIO (DENTRO DO MESMO BLOCO) */}
